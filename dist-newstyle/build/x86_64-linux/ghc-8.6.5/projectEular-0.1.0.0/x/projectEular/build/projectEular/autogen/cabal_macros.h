...
/* package projectEular-0.1.0.0 */
#ifndef VERSION_projectEular
#define VERSION_projectEular "0.1.0.0"
#endif /* VERSION_projectEular */
#ifndef MIN_VERSION_projectEular
#define MIN_VERSION_projectEular(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projectEular */
...
#define CURRENT_COMPONENT_ID "projectEular-0.1.0.0-inplace-projectEular"
